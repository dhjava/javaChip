...
<%@ include file="../include/nav.jsp" %>
	<div class="frame login">
		<form name="goodbye frm" action="goodbye.do" method="post" onsubmit="return checks()">
			<h3>회원탈퇴</h3>
			<div class="main login">
				...
				<input type="password" style="margin-top:10px;" id="uPw" name="uPw"  placeholder="비밀번호 입력"><br>
			</div>

	...
	<section class="join spad">
        <div class="container">
            <div class="join__form">
                <h4>회원정보 수정</h4>
                <form action="myinfo.do" method="post" onsubmit="return checks()">
                    <div class="join__input">
                        ...
                        <p>성명<span>*</span></p>
                        	...
                        	<div class="msg"></div>
                        <p>주소<span>*</span></p>
	                        <input type="text" placeholder="우편번호" class="join__input__short" id="uAddNum" name="uAdd" value="${login.uAdd}">
